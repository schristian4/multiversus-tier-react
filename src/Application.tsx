...
const Application = () => {
	...
	const [characterListRef, setCharacterListRef] = useState<string[]>([
		'batman',
		'finn',
		'superman',
		'bugs',
  ...
  function handleInputChange(evt: any ) {
	...
	function searchCharacter(targetValue: string) {
		...
		var filtered = characterList.filter(	
			function(character){
	...
	return (
		<div className="main-container glassmorph">
			<HeaderComponent handleReset={handleReset} handleInputChange={handleInputChange} searchInputValue ={searchInputValue}/>
